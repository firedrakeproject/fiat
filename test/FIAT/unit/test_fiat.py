...
elements = [
    ...
    "CrouzeixRaviart(S, 3)",
    "CrouzeixRaviart(S, 5)",
    "CrouzeixRaviart(I, 1, variant='equispaced')",
    "CrouzeixRaviart(T, 1, variant='equispaced')",
    "CrouzeixRaviart(S, 1, variant='equispaced')",
    "CrouzeixRaviart(T, 3, variant='equispaced')",
    "CrouzeixRaviart(T, 5, variant='equispaced')",
    "RaviartThomas(I, 1)",
    "RaviartThomas(I, 2)",
    "RaviartThomas(I, 3)",
    "RaviartThomas(T, 1)",
