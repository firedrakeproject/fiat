...
from FIAT.reference_element import Point, TensorProductCell, \
    DefaultQuadrilateral, UFCQuadrilateral, DefaultHexahedron, UFCHexahedron

point = Point()
interval = UFCInterval()
triangle = UFCTriangle()
ufc_quadrilateral = UFCQuadrilateral()
default_quadrilateral = DefaultQuadrilateral()
ufc_hexahedron = UFCHexahedron()
default_hexahedron = DefaultHexahedron()
...
quadrilateral_x_interval = TensorProductCell(ufc_quadrilateral, interval)
...
@pytest.mark.parametrize(('cell', 'connectivity'),
                         [(tetrahedron, ufc_tetrahedron_21connectivity),
                          (ufc_hexahedron, ufc_hexahedron_21connectivity),
...
@pytest.mark.parametrize('cell',
                         [point, interval, triangle, tetrahedron,
                          ufc_quadrilateral, default_quadrilateral,
                          ufc_hexahedron, default_hexahedron,
...
@pytest.mark.parametrize(('cell', 'point', 'epsilon', 'expected'),
                         [(interval, [0.5], 0.0, True),
                          ...
                          (ufc_quadrilateral, [0.5, 0.5], 0.0, True),
                          (ufc_quadrilateral, [0.0, 0.0], 1e-14, True),
                          (ufc_quadrilateral, [1.0, 0.0], 1e-14, True),
                          (ufc_quadrilateral, [0.0, 1.0], 1e-14, True),
                          (ufc_quadrilateral, [1.0, 1.0], 1e-14, True),
                          (ufc_quadrilateral, [-1e-12, 0.5], 1e-11, True),
                          (ufc_quadrilateral, [1+1e-12, 0.5], 1e-11, True),
                          (ufc_quadrilateral, [0.5, -1e-12], 1e-11, True),
                          (ufc_quadrilateral, [0.5, 1+1e-12], 1e-11, True),
                          (ufc_quadrilateral, [-1e-12, 0.5], 1e-13, False),
                          (ufc_quadrilateral, [1+1e-12, 0.5], 1e-13, False),
                          (ufc_quadrilateral, [0.5, -1e-12], 1e-13, False),
                          (ufc_quadrilateral, [0.5, 1+1e-12], 1e-13, False),
                          ...
                          (ufc_hexahedron, [0.5, 0.5, 0.5], 0.0, True),
                          (ufc_hexahedron, [0.0, 0.0, 0.0], 1e-14, True),
                          (ufc_hexahedron, [1.0, 0.0, 0.0], 1e-14, True),
                          (ufc_hexahedron, [0.0, 1.0, 0.0], 1e-14, True),
                          (ufc_hexahedron, [0.0, 0.0, 1.0], 1e-14, True),
                          (ufc_hexahedron, [1.0, 1.0, 0.0], 1e-14, True),
                          (ufc_hexahedron, [1.0, 0.0, 1.0], 1e-14, True),
                          (ufc_hexahedron, [0.0, 1.0, 1.0], 1e-14, True),
                          (ufc_hexahedron, [1.0, 1.0, 1.0], 1e-14, True),
                          (ufc_hexahedron, [-1e-12, 0.5, 0.5], 1e-11, True),
                          (ufc_hexahedron, [0.5, -1e-12, 0.5], 1e-11, True),
                          (ufc_hexahedron, [0.5, 0.5, -1e-12], 1e-11, True),
                          (ufc_hexahedron, [1+1e-12, 0.5, 0.5], 1e-11, True),
                          (ufc_hexahedron, [0.5, 1+1e-12, 0.5], 1e-11, True),
                          (ufc_hexahedron, [0.5, 0.5, 1+1e-12], 1e-11, True),
                          (ufc_hexahedron, [-1e-12, 0.5, 0.5], 1e-13, False),
                          (ufc_hexahedron, [0.5, -1e-12, 0.5], 1e-13, False),
                          (ufc_hexahedron, [0.5, 0.5, -1e-12], 1e-13, False),
                          (ufc_hexahedron, [1+1e-12, 0.5, 0.5], 1e-13, False),
                          (ufc_hexahedron, [0.5, 1+1e-12, 0.5], 1e-13, False),
                          (ufc_hexahedron, [0.5, 0.5, 1+1e-12], 1e-13, False),
...
@pytest.mark.parametrize(('cell', 'point', 'expected'),
                         [(interval, [0.5], 0.0),
                          ...
                          (ufc_quadrilateral, [0.5, 0.5], 0.0),
                          (ufc_quadrilateral, [0.0, 0.0], 0.0),
                          (ufc_quadrilateral, [1.0, 0.0], 0.0),
                          (ufc_quadrilateral, [0.0, 1.0], 0.0),
                          (ufc_quadrilateral, [1.0, 1.0], 0.0),
                          (ufc_quadrilateral, [-1e-12, 0.5], 1e-12),
                          (ufc_quadrilateral, [1+1e-12, 0.5], 1e-12),
                          (ufc_quadrilateral, [0.5, -1e-12], 1e-12),
                          (ufc_quadrilateral, [0.5, 1+1e-12], 1e-12),
                          (ufc_quadrilateral, [-1e-12, 0.5], 1e-12),
                          (ufc_quadrilateral, [1+1e-12, 0.5], 1e-12),
                          (ufc_quadrilateral, [1+1e-12, 1+1e-12], 2e-12),
                          ...
                          (ufc_hexahedron, [0.5, 0.5, 0.5], 0.0),
                          (ufc_hexahedron, [0.0, 0.0, 0.0], 0.0),
                          (ufc_hexahedron, [1.0, 0.0, 0.0], 0.0),
                          (ufc_hexahedron, [0.0, 1.0, 0.0], 0.0),
                          (ufc_hexahedron, [0.0, 0.0, 1.0], 0.0),
                          (ufc_hexahedron, [1.0, 1.0, 0.0], 0.0),
                          (ufc_hexahedron, [1.0, 0.0, 1.0], 0.0),
                          (ufc_hexahedron, [0.0, 1.0, 1.0], 0.0),
                          (ufc_hexahedron, [1.0, 1.0, 1.0], 0.0),
                          (ufc_hexahedron, [-1e-12, 0.5, 0.5], 1e-12),
                          (ufc_hexahedron, [0.5, -1e-12, 0.5], 1e-12),
                          (ufc_hexahedron, [0.5, 0.5, -1e-12], 1e-12),
                          (ufc_hexahedron, [1+1e-12, 0.5, 0.5], 1e-12),
                          (ufc_hexahedron, [0.5, 1+1e-12, 0.5], 1e-12),
                          (ufc_hexahedron, [0.5, 0.5, 1+1e-12], 1e-12),
                          (ufc_hexahedron, [-1e-12, -1e-12, -1e-12], 3e-12),
                          (ufc_hexahedron, [1.0+1e-12, -1e-12, -1e-12], 3e-12),
                          (ufc_hexahedron, [-1e-12, 1.0+1e-12, -1e-12], 3e-12),
                          (ufc_hexahedron, [-1e-12, -1e-12, 1.0+1e-12], 3e-12),
                          (ufc_hexahedron, [1.0+1e-12, 1.0+1e-12, -1e-12], 3e-12),
                          (ufc_hexahedron, [1.0+1e-12, -1e-12, 1.0+1e-12], 3e-12),
                          (ufc_hexahedron, [-1e-12, 1.0+1e-12, 1.0+1e-12], 3e-12),
                          (ufc_hexahedron, [1.0+1e-12, 1.0+1e-12, 1.0+1e-12], 3e-12),
